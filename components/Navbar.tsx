    ...
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${scrolled ? 'bg-black/80 backdrop-blur-md h-16' : 'h-24'}`}>
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 group cursor-pointer">
          ...
          <span className="text-xl font-bold tracking-tighter uppercase font-heading">Archi-Tek</span>
        </div>
        ...
        <div className="flex items-center gap-8">
          ...
          <button className="bg-primary hover:bg-white hover:text-black text-white px-8 py-3 text-[10px] font-bold uppercase tracking-[0.2em] transition-all duration-300">
            View Portfolio
          </button>
        </div>
      </div>
